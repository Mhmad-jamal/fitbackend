...
(14, '0X1VBCcnG1gxUXdFWwbeagJLySR2');
...
(21, 'test', 'test', 'test', 'test', 7, 3, 'exercise_1691322934.jpg', '', '<p>test</p>', '<p>test</p>');
...
(2, 'User', 'user@user.com', 'FF737CFC58DC1105BA8E85F280F9FC7DF4949BA227E8BA01D84258545039805E05CC51547B8F02838B1A113E292A58DAA1AA7B3813828A558396C498183EC49D', NULL, 'avatar.png', 1, 0, '2023-07-11 16:42:21', '2021-12-16 09:41:04');
...
CREATE TABLE `place` (
  `id` int(11) NOT NULL,
  `place_value` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `place` (`id`, `place_value`) VALUES
(1, 'At GYM'),
(2, 'At Home');
...
CREATE TABLE `users_goal` (
  ...
  `user_goal` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`user_goal`)),
...
--
-- Table structure for table `usesr_goal_workout`
--
...
--
-- Dumping data for table `usesr_goal_workout`
--
...
INSERT INTO `we_day6` (`exercise_id`, `workout_id`, `day_6`, `eorder`) VALUES
(5, 21, 6, NULL);
...
CREATE TABLE `workouts` (
  ...
  `workout_place` int(11) DEFAULT NULL,
  `workout_gender` int(11) DEFAULT NULL,
...
ALTER TABLE `workouts`
  ...
  ADD KEY `workout_gender` (`workout_gender`),
  ADD KEY `workout_place` (`workout_place`);
...
--
-- Constraints for table `usesr_goal_workout`
--
ALTER TABLE `usesr_goal_workout`
...
ALTER TABLE `workouts`
  ...
  ADD CONSTRAINT `workouts_ibfk_1` FOREIGN KEY (`workout_gender`) REFERENCES `gender` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `workouts_ibfk_2` FOREIGN KEY (`workout_place`) REFERENCES `place` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
