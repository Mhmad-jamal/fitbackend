...
<input type="hidden" name="id" value="<?php echo $subscription["id"]?>" >
    ...
    <div class="row  mt-3">
        ...
        <input type="date" value="<?php echo $subscription["start_date"]?>" required placeholder="date" name="start_date" class="form-control" required="">
    </div>
    </div>
    <div class="row  mt-3">
   ...
   <input type="date" value="<?php echo $subscription["end_date"]?>" required placeholder="date" name="end_date" class="form-control" required="">
</div>
</div>
<div class="row  mt-3">
