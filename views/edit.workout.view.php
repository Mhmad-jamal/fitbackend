...
<div class="col-1 flexCenter">
<input type="button" name="view" value="reorder" workoutid="<?php echo $workout["workout_id"]; ?>" day="1" class="btn orderBtn btn-info btn-xs view_data" />
</div>
...
<div class="col-1 flexCenter">
<input type="button" name="view" value="reorder" workoutid="<?php echo $workout["workout_id"]; ?>" day="2" class="btn orderBtn btn-info btn-xs view_data" />
</div>
...
<div class="col-1 flexCenter">
<input type="button" name="view" value="reorder" workoutid="<?php echo $workout["workout_id"]; ?>" day="3" class="btn orderBtn btn-info btn-xs view_data" />
</div>
...
<div class="col-1 flexCenter">
<input type="button" name="view" value="reorder" workoutid="<?php echo $workout["workout_id"]; ?>" day="4" class="btn orderBtn btn-info btn-xs view_data" />
</div>
...
<div class="col-1 flexCenter">
<input type="button" name="view" value="reorder" workoutid="<?php echo $workout["workout_id"]; ?>" day="5" class="btn orderBtn btn-info btn-xs view_data" />
</div>
</div>
...
<div class="col-1 flexCenter">
<input type="button" name="view" value="reorder" workoutid="<?php echo $workout["workout_id"]; ?>" day="6" class="btn orderBtn btn-info btn-xs view_data" />
</div>
</div>
...
<div class="col-1 flexCenter">
<input type="button" name="view" value="reorder" workoutid="<?php echo $workout["workout_id"]; ?>" day="7" class="btn orderBtn btn-info btn-xs view_data" />
</div>
...
if (strpos($in, $workout['workout_status']) !== false) {
    echo '<div class="radio radio-success"> <input type="radio" name="workout_status" id="radio5" value="'. $workout['workout_status'] .'" checked=""> <label for="radio5"> Active </label> </div>';
}else{
  echo '<div class="radio radio-success"> <input type="radio" name="workout_status" id="radio5" value="' . $in .'"> <label for="radio5"> Active </label> </div>';
}
                         ?>
                        </div>
...
if (strpos($out, $workout['workout_status']) !== false) {
    echo '<div class="radio radio-danger"> <input type="radio" name="workout_status" id="radio6" value="0" checked=""> <label for="radio6"> Inactive </label> </div>';
}else{
  echo '<div class="radio radio-danger"> <input type="radio" name="workout_status" id="radio6" value="'. $out .'"> <label for="radio6"> Inactive </label> </div>';
}
                         ?>
                        </div>
...
<div id="dataModal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content" style="max-height: 480px;">  
                ...
                <span id="resultAjx"></span>
                <div class="modal-body" id="modal_detail" style="max-height: 480px; overflow: auto;">  
                </div>
                <div class="modal-footer">  
                     <button type="submit" class="btn btn-primary btnSave" onClick="saveOrder();">Save</button>  
