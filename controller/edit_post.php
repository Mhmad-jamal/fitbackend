...
$statment = $connect->prepare("UPDATE posts SET post_title = :post_title, post_description = :post_description, post_tag = :post_tag, post_featured = :post_featured, post_status = :post_status, post_image = :post_image WHERE post_id = :post_id");
